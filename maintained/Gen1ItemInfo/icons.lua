-- Gen1ItemInfo: the item icons.
--
-- Returns a factory: factory(mod) -> a table of helpers.
--
-- Gen1ModernBag carries this file too, and carried rather than depended on for
-- the reason this suite gives everywhere else it copies sixty lines: a Bag
